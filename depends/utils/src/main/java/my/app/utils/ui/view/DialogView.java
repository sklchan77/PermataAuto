...
import static my.app.utils.R.styleable.DialogView_listLayout;
import static my.app.utils.R.styleable.DialogView_singleChoiceItemLayout;
...
public class DialogView extends FrameLayout implements DialogInterface {
	...
	public static abstract class Builder implements DialogBuilder {
		...
		public Builder(Context context) {
			...
			int theme = ta.getResourceId(0, my.app.utils.R.style.Theme_Utils_Base_AlertDialog);
			ta.recycle();
			...
			ta = ctx.obtainStyledAttributes(null,
					...
					my.app.utils.R.style.Theme_Utils_Base_AlertDialog_Style);
		...
		public DialogBuilder setSingleChoiceItems(@NonNull CharSequence[] items, int checkedItem,
			...
			TypedArray a = ctx.obtainStyledAttributes(null, my.app.utils.R.styleable.DialogView,
					androidx.appcompat.R.attr.alertDialogStyle,
					my.app.utils.R.style.Theme_Utils_Base_AlertDialog_Style);
