...
import my.app.utils.net.http.HttpError.MethodNotAllowed;
import my.app.utils.net.http.HttpError.NotFound;
import my.app.utils.net.http.HttpError.PayloadTooLarge;
import my.app.utils.net.http.HttpError.UriTooLong;
import my.app.utils.net.http.HttpError.VersionNotSupported;
