...
import static my.app.utils.net.http.HttpHeader.ACCEPT_RANGES;
import static my.app.utils.net.http.HttpHeader.CONNECTION;
import static my.app.utils.net.http.HttpHeader.CONTENT_LENGTH;
import static my.app.utils.net.http.HttpHeader.CONTENT_RANGE;
import static my.app.utils.net.http.HttpResponseBuilder.supplier;
import static my.app.utils.net.http.HttpVersion.HTTP_1_1;
...
import my.app.utils.net.http.HttpError;
import my.app.utils.net.http.HttpError.Forbidden;
import my.app.utils.net.http.HttpError.NotFound;
import my.app.utils.net.http.HttpError.ServiceUnavailable;
import my.app.utils.net.http.HttpHeader;
import my.app.utils.net.http.HttpMethod;
import my.app.utils.net.http.HttpRequest;
import my.app.utils.net.http.HttpRequestHandler;
import my.app.utils.net.http.HttpResponseBuilder;
import my.app.utils.net.http.HttpVersion;
import my.app.utils.net.http.Range;
