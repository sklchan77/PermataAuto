package my.app.permata.addon.felex.media;
...
import my.app.permata.media.lib.BrowsableItemBase;
...
import my.app.permata.media.lib.PlayableItemBase;
...
public interface FelexItem extends MediaLib.Item {
	...
	class Root extends ItemContainer<FelexItem> implements FelexItem {
		...
		public String getName() {
			return getLib().getContext().getString(my.app.permata.R.string.addon_name_felex);
		}
	...
	class Dict extends BrowsableItemBase implements FelexItem {
		private final my.app.permata.addon.felex.dict.Dict dict;

		public Dict(DefaultMediaLib lib, my.app.permata.addon.felex.dict.Dict dict) {
		...
		public my.app.permata.addon.felex.dict.Dict getDict() {
			return dict;
		}
	...
	class Tutor extends PlayableItemBase implements FelexItem {
		...
		public static Tutor create(DefaultMediaLib lib, my.app.permata.addon.felex.dict.Dict dict,
															 DictTutor.Mode mode) {
