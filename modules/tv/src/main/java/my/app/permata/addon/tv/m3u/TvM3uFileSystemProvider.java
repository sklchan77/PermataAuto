...
import static my.app.permata.addon.tv.m3u.TvM3uFile.CATCHUP_DAYS;
import static my.app.permata.addon.tv.m3u.TvM3uFile.CATCHUP_QUERY;
import static my.app.permata.addon.tv.m3u.TvM3uFile.CATCHUP_TYPE;
import static my.app.permata.addon.tv.m3u.TvM3uFile.CATCHUP_TYPE_APPEND;
import static my.app.permata.addon.tv.m3u.TvM3uFile.CATCHUP_TYPE_AUTO;
import static my.app.permata.addon.tv.m3u.TvM3uFile.CATCHUP_TYPE_DEFAULT;
import static my.app.permata.addon.tv.m3u.TvM3uFile.EPG_FILE_AGE;
import static my.app.permata.addon.tv.m3u.TvM3uFile.EPG_SHIFT;
import static my.app.permata.addon.tv.m3u.TvM3uFile.EPG_URL;
import static my.app.permata.addon.tv.m3u.TvM3uFile.LOGO_PREFER_EPG;
import static my.app.permata.addon.tv.m3u.TvM3uFile.LOGO_URL;
import static my.app.permata.vfs.m3u.M3uFile.NAME;
import static my.app.permata.vfs.m3u.M3uFile.URL;
import static my.app.utils.async.Completed.completedNull;
import static my.app.utils.net.http.HttpFileDownloader.AGENT;
...
public class TvM3uFileSystemProvider extends M3uFileSystemProvider {
	...
	private FutureSupplier<Boolean> requestPrefs(MainActivityDelegate a, PreferenceStore ps) {
		...
		prefs.addStringPref(o -> {
			o.store = ps;
			o.pref = NAME;
			o.title = my.app.permata.R.string.m3u_playlist_name;
		});
		prefs.addFilePref(o -> {
			o.store = ps;
			o.pref = URL;
			o.mode = FilePickerFragment.FILE;
			o.title = my.app.permata.R.string.m3u_playlist_location;
			o.stringHint = a.getString(my.app.permata.R.string.m3u_playlist_location_hint);
		});
		...
		sub.addStringPref(o -> {
			o.store = ps;
			o.pref = AGENT;
			o.title = my.app.permata.R.string.m3u_playlist_agent;
			o.stringHint = "Permata/" + BuildConfig.VERSION_NAME;
		});
		sub.addIntPref(o -> {
			o.store = ps;
			o.pref = RESP_TIMEOUT;
			o.title = my.app.permata.R.string.m3u_playlist_timeout;
		});
