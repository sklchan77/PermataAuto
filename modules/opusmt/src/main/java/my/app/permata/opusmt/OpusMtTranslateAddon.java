package my.app.permata.opusmt;

import static java.nio.charset.StandardCharsets.UTF_8;
import static java.nio.file.Files.readAllBytes;
import static java.util.Collections.emptyList;
import static java.util.Objects.requireNonNull;
import static my.app.permata.opusmt.SentencePieceTokenizer.fromJson;
...
public class OpusMtTranslateAddon extends TranslateAddon {
	private static final AddonInfo info =
			PermataAddon.findAddonInfo(OpusMtTranslateAddon.class.getName());
