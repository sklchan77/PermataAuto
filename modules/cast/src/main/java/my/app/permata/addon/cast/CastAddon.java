...
public class CastAddon
		implements PermataMediaServiceAddon, PermataToolAddon, SessionManagerListener<CastSession> {
	private static final AddonInfo info = PermataAddon.findAddonInfo(CastAddon.class.getName());
	@Nullable
	...
	public int getAddonId() {
		return my.app.permata.R.id.cast_addon;
	}
