...
#define  LOG_TAG "[my.app.permata.Whisper]"
...
Java_my_app_permata_whisper_Whisper_create(JNIEnv *env, jclass, jstring jModelPath,
...
Java_my_app_permata_whisper_Whisper_resample(JNIEnv *env, jclass, jlong sessionPtr, jobject byteBuf,
...
extern "C" JNIEXPORT jint JNICALL
Java_my_app_permata_whisper_Whisper_fullTranscribe(JNIEnv *env, jclass, jlong sessionPtr) {
	assert(sessionPtr);
	auto session = reinterpret_cast<WhisperSession *>(sessionPtr);
...
Java_my_app_permata_whisper_Whisper_text(JNIEnv *env, jclass, jlong sessionPtr, jint segmentIdx) {
	assert(sessionPtr);
	auto session = reinterpret_cast<WhisperSession *>(sessionPtr);
...
extern "C" JNIEXPORT jlong JNICALL
Java_my_app_permata_whisper_Whisper_start(JNIEnv *, jclass, jlong sessionPtr, jint segmentIdx) {
	assert(sessionPtr);
	auto session = reinterpret_cast<WhisperSession *>(sessionPtr);
...
extern "C" JNIEXPORT jlong JNICALL
Java_my_app_permata_whisper_Whisper_end(JNIEnv *, jclass, jlong sessionPtr, jint segmentIdx) {
	assert(sessionPtr);
	auto session = reinterpret_cast<WhisperSession *>(sessionPtr);
	auto t = session->timestampOffset +
...
extern "C" JNIEXPORT jstring JNICALL
Java_my_app_permata_whisper_Whisper_lang(JNIEnv *env, jclass, jlong sessionPtr) {
	assert(sessionPtr);
	auto session = reinterpret_cast<WhisperSession *>(sessionPtr);
...
extern "C" JNIEXPORT void JNICALL
Java_my_app_permata_whisper_Whisper_reset(JNIEnv *, jclass, jlong sessionPtr) {
	assert(sessionPtr);
	auto session = reinterpret_cast<WhisperSession *>(sessionPtr);
	session->reset();
}
...
extern "C" JNIEXPORT void JNICALL
Java_my_app_permata_whisper_Whisper_release(JNIEnv *, jclass, jlong sessionPtr) {
