 ...
 * @author sklchan77
 */
public class PermataChromeClient extends WebChromeClient {
	private final PermataWebView web;
	...
	public PermataChromeClient(PermataWebView web, ViewGroup fullScreenView) {
		this.web = web;
