...
public abstract class VfsProviderBase implements VfsProvider {
	...
	protected FutureSupplier<VirtualResource> pickFolder(
		...
		if (!(a.showFragment(my.app.utils.R.id.file_picker) instanceof FilePickerFragment f))
			return cancelled();
	...
	protected FutureSupplier<Boolean> requestPrefs(
		...
		if (!(a.showFragment(
				my.app.utils.R.id.generic_dialog_fragment) instanceof GenericDialogFragment f))
			return cancelled();
