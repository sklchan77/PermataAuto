...
import static my.app.permata.media.pref.MediaPrefs.HW_ACCEL_AUTO;
...
import static my.app.permata.media.pref.MediaPrefs.VIDEO_SCALE;
import static my.app.permata.media.pref.PlayableItemPrefs.BOOKMARKS;
import static my.app.permata.media.pref.PlayableItemPrefs.bookmarkTime;
import static my.app.permata.ui.fragment.SettingsFragment.addAudioPrefs;
import static my.app.permata.ui.fragment.SettingsFragment.addAutoSubPrefs;
import static my.app.permata.ui.fragment.SettingsFragment.addDelayPrefs;
import static my.app.permata.ui.fragment.SettingsFragment.addSubSizePrefs;
import static my.app.permata.ui.fragment.SettingsFragment.addSubtitlePrefs;
...
import my.app.permata.media.lib.FileItem;
import my.app.permata.media.lib.FolderItem;
...
public class MediaItemMenuHandler implements OverlayMenu.SelectionHandler {
	...
	protected void buildAudioMenu(OverlayMenu.Builder b) {
		...
		Pref<IntSupplier> pref = PermataApplication.get().isConnectedToAuto()
