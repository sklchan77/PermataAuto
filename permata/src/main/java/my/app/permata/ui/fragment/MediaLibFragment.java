...
import static my.app.permata.media.pref.BrowsableItemPrefs.SORT_MASK_NAME_RND;
import static my.app.permata.ui.activity.MainActivityPrefs.getGridViewPrefKey;
import static my.app.permata.ui.activity.MainActivityPrefs.hasGridViewPref;
import static my.app.permata.ui.activity.MainActivityPrefs.hasTextIconSizePref;
...
import my.app.permata.media.lib.MediaLib.EpgItem;
...
import my.app.permata.ui.view.MediaItemListViewAdapter;
import my.app.permata.ui.view.MediaItemMenuHandler;
import my.app.permata.ui.view.MediaItemView;
...
public abstract class MediaLibFragment extends MainActivityFragment implements MainActivityListener,
		PreferenceStore.Listener, PermataServiceUiBinder.Listener, ToolBarView.Listener {
	private ListAdapter adapter;
	private boolean noScroll;
	private int scrollPosition;
	private Item clicked;

	protected abstract ListAdapter createAdapter(PermataServiceUiBinder b);
	...
	public void contributeToNavBarMenu(OverlayMenu.Builder builder) {
		...
		if (a.getListView().isSelectionActive()) {
			b.addItem(R.id.nav_select_all, my.app.utils.R.drawable.check_box, R.string.select_all);
			b.addItem(R.id.nav_unselect_all, my.app.utils.R.drawable.check_box_blank,
					R.string.unselect_all);
		} else {
			b.addItem(R.id.nav_select, my.app.utils.R.drawable.check_box, R.string.select);
		}
	}
