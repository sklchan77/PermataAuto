 ...
 * @author sklchan77
 */
public class PermataServiceUiBinder extends BasicEventBroadcaster<PermataServiceUiBinder.Listener>
	...
	PermataServiceUiBinder(PermataMediaServiceConnection c) {
	...
	private final class MediaControllerCallback extends MediaControllerCompat.Callback {
		private final Handler handler = PermataApplication.get().getHandler();
