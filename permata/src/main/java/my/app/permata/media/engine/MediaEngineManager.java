...
import static my.app.permata.media.pref.MediaLibPrefs.EXO_ENABLED;
import static my.app.permata.media.pref.MediaLibPrefs.VLC_ENABLED;
...
import static my.app.permata.media.pref.MediaPrefs.VIDEO_ENGINE;
...
public class MediaEngineManager implements PreferenceStore.Listener {
	private static final String EXO_PROV_CLASS =
			"my.app.permata.engine.exoplayer.ExoPlayerEngineProvider";
	private static final String VLC_PROV_CLASS = "my.app.permata.engine.vlc.VlcEngineProvider";
	...
	private FutureSupplier<Void> installPlayer(String module, @StringRes int engineName) {
		...
		String channelId = "permata.engine.install";
