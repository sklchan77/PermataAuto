...
import static my.app.permata.BuildConfig.APPLICATION_ID;
import static my.app.permata.auto.LauncherActivity.INTENT_EXTRA_MODE;
...
public class Xposed implements IXposedHookLoadPackage {
	...
	private static final String EV_SRV_CON_FIELD = "__permata_event_dispatcher_service__";
	...
	private static final String DISPATCHER_CLASS_NAME =
			"my.app.permata.auto.XposedEventDispatcherService";

	@Override
	public void handleLoadPackage(XC_LoadPackage.LoadPackageParam lpparam) {
		var pkgName = lpparam.packageName;
		log("[Permata] Hooking into package " + pkgName);
	...
	private static void debug(Object... msg) {
		...
		if (msg.length == 1) {
			...
			var sb = new StringBuilder("[Permata] ");
